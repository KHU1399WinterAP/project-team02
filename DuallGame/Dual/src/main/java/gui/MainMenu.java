...
public class MainMenu extends javax.swing.JFrame {
    ...
    private void setMyThem() {
        Utility.setThemForButton(MyColor.WHITE, MyColor.MY_GREEN, registerButton, loginButton);
        Utility.setThemForButton(MyColor.WHITE, MyColor.MY_RED, exitButton);
        Utility.setThemForPanel(MyColor.MY_GREEN, mainOptionPanel);
    ...
    private void setMyFont() throws FontFormatException, IOException {
        MyFont.setMyFont(Links.MAIN_FONT, MyFont.PLAIN, 40, registerButton, loginButton, exitButton);
